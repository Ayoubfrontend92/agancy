...
import { Container, Tabs, Tab, Alert, Col, Row, Button, Modal, Accordion } from 'react-bootstrap'
            ...
            <Container>
                ...
                <Modal show={show} onHide={handleClose}>
                    ...
                    <Modal.Footer className="justify-content-center">
                        ...
                        <Link to={`/global-services/${title}/declaration`} className="btn btn-primary">
