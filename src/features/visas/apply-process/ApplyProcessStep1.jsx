...
import { OverlayTrigger, Tooltip, Button, Table, Modal, Form, Alert, Row, Col } from 'react-bootstrap'
        ...
        <div className="app-process-1">
            ...
            <Row>
                <Form.Group as={Col} lg="6" className="mb-3">
                    <Form.Label><Translate value="visas.applyProcess.q_1" /></Form.Label>
            ...
            <Row>
                <Form.Group as={Col} lg="6" className="mb-3">
                    <Form.Label><Translate value="visas.applyProcess.q_2" /></Form.Label>
                    <Form.Select aria-label="Default select example">
                        <option>Open this select menu</option>
                        <option value="1">One</option>
                        <option value="2">Two</option>
            ...
            <Row>
                <Form.Group as={Col} lg="6" className="mb-3">
                    <Form.Label><Translate value="visas.applyProcess.q_3" /></Form.Label>
                    <Form.Select aria-label="Default select example">
                        <option>Open this select menu</option>
                        <option value="1">One</option>
                        <option value="2">Two</option>
            ...
            <Row>
                <Form.Group as={Col} lg="6" className="mb-3">
                    <Form.Label><Translate value="visas.applyProcess.q_4" /></Form.Label>
                    <Form.Select aria-label="Default select example">
                        <option>Open this select menu</option>
                        <option value="1">One</option>
                        <option value="2">Two</option>
            ...
            <Row>
                <Form.Group as={Col} lg="5" className="mb-3">
                    <Form.Label><Translate value="visas.applyProcess.q_5" /></Form.Label>
                    <Form.Control type="email" placeholder="" />
                </Form.Group>
                <Col lg="12" className="mb-3"><Translate value="global.or" /></Col>
                <Form.Group as={Col} lg="5" className="mb-3">
