                ...
                <div className="row justify-content-center">
                    <div className="col-lg-7">
                        <h4 className="text-center mb-5">
                            <Translate value="find_more.application_status.title_fail" />
                        </h4>

                        <h4 className="text-center mb-5">
                            <Translate value="find_more.application_status.title_fail_help" />
                        </h4>

                        <h4 className="text-center mb-5">
                            <Translate value="find_more.application_status.title_success" />
                        </h4>
                        ...
                        <div className="row mb-3">
                            ...
                            <div className="col-6">
                                <Link to="/find-more/application-status/retrieve" className="btn btn-lg w-100 btn-primary py-4">
                                    <Translate value="find_more.application_status.retrieve_app_num" />
                                </Link>
                            </div>
                        </div>
