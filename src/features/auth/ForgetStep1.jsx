...
const ForgetStep1 = () => {
    return (
        <>
            <h2 className="mb-3">
                <Translate value="find_more.auth.forgotPassword.stepNotifier" /> 1  <Translate value="find_more.auth.forgotPassword.of" /> 2
            </h2>
                        ...
                        <Form>
                            ...
                            <div className="d-flex justify-content-end">
                                <button className="btn btn-timnak shadow-lg px-5" type="submit">
                                    <Translate value="find_more.auth.forgotPassword.step1_btn" />
                                </button>
                            </div>
                        </Form>
                    </div>
                    ...
                    <div className="shadow-sm rounded">
                        <div className="bg-timnak-light text-center p-3">
                            <h4 className="mb-0 fw-bold">
                                <Translate value="find_more.auth.forgotPassword.step1_hint_title" />
                            </h4>
                        </div>
                        <div className="p-3 bg-white">
                            <p className="mb-0" style={{ textAlign: "justify" }}>
                                <Translate value="find_more.auth.forgotPassword.step1_hint_description" />
                            </p>
                        </div>
                    </div>
                </div>
